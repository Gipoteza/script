...
if __name__ == "__main__":
    ...
    symbolWithdraw = 'ETH'
    network        = 'ETH' # ETH | BSC | AVAXC | MATIC | ARBITRUM | OPTIMISM | APT

    # api_keys of binance
    API_KEY     = "EkCyTSt82Zp58Nt9zKYExVDfKuJhr"
    API_SECRET  = "gUr25i4TIG48OikJPCpnR7rNAWnW7"
    AMOUNT_FROM = 0.0098
    AMOUNT_TO   = 0.00111
    ...
    for wallet in wallets_list:
        ...
        time.sleep(random.randint(15, 88))
